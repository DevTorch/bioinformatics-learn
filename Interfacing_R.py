...
seq_data = read_delim('datasets/sequence.index', header=True, stringsAsFactors=False)
#In R:
#  seq.data <- read.delim('datasets/sequence.index', header=TRUE, stringsAsFactors=FALSE)
...
# Let's remove all withdrawn sequences
...
robjects.r.png('out/out_bar.png', width=16, height=9, units="in", res=600)
bar.plot()
dev_off = robjects.r('dev.off')
dev_off()
Image(filename='out/out_bar.png')
...
robjects.r.png('out/out_scatter.png', width=16, height=9, units="in", res=600)
scatter.plot()
dev_off = robjects.r('dev.off')
dev_off()
Image(filename='out/out_scatter.png')
